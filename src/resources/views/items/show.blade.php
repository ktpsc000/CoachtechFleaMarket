...
<div class="show-content">
    ...
    <div class="show-info">
        ...
        <div class="show-info__description">
            ...
            <p class="show-info__description-text"></p>{{$item->description}}
        </div>
        ...
        <div class="show-info__detail">
            ...
            <div class="show-info__condition">
                ...
                <p class="show-info__condition-text">{{$item->condition_text}}</p>
            </div>
        ...
        <div class="show-info__comment">
            ...
            <div class="show-info__comment-store">
                ...
                <form action="/item/{{$item->id}}" method="post">
                    @csrf
                    <input class="show-info__comment-store--input" type="text" name="content">
                    @error('content')
                    {{ $message }}
                    @enderror
